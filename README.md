## We distribute the processed brain structural covariate network data for maltreated children
...
![alt text](https://github.com/laplcebeltrami/barcodes/blob/main/jackknife_bar.pdf?raw=true)
